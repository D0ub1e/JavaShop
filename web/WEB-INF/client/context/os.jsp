...
<div class="container">
    <div class="jumbotron" >
        <h1>Smartisan OS
            <br>
            <small>The best of Andriod</small>
        </h1>
    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" id="myNav">
                <li class="active"><a href="#section-1">OS 3.1</a></li>
                <li><a href="#section-2">好用</a></li>
                <li><a href="#section-3">好看</a></li>
                <li><a href="#section-4">人性化</a></li>
                <li><a href="#section-5">丰富</a></li>
            </ul>
        </div>
        <div class="col-xs-9">
            <h2 id="section-1">OS 3.1</h2>
            <p> 开创性地加入了 One Step 、Big Bang 等新特性，创造出信息处理的全新交互模式</p>
            <p> 结合在语音转文字领域技术遥遥领先的讯飞语音输入，从文字输入、编辑、分享和不同应用间协作等方面</p>
            <p>大幅提升智能手机的效率，令其他手机操作系统望尘莫及</p>
            ...
            <p>开创性地解决了在手机屏幕上难于处理文字的弊端</p>
            <hr >
            <h2 id="section-2">好看</h2>
